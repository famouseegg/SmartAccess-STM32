...
class SerialTransfer {
 public:  // <<---------------------------------------//public
  ...
  void begin(UART_HandleTypeDef* _port, const configST configs);
  void begin(UART_HandleTypeDef* _port, const bool _debug = true,
             UART_HandleTypeDef* _debugPort = NULL,
  ...
  /*
   uint16_t SerialTransfer::txObj(const T &val, const uint16_t &index=0, const
   uint16_t &len=sizeof(T)) Description:
   ------------
  ...
  */
  ...
  /*
   uint16_t SerialTransfer::rxObj(const T &val, const uint16_t &index=0, const
   uint16_t &len=sizeof(T)) Description:
   ------------
  ...
  */
  ...
  /*
   uint8_t SerialTransfer::sendDatum(const T &val, const uint16_t
